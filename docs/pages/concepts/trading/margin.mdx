...
<pre class="center-column">
  Initial Margin Requirement = abs(S &times; P &times; I) Maintenance Margin
  Requirement = abs(S &times; P &times; M)
</pre>
...
<pre class="center-column">
  Total Initial Margin Requirement = Σ abs(S<sub>i</sub> &times; P<sub>i</sub>{" "}
  &times; I<sub>i</sub>) Total Maintenance Margin Requirement = Σ abs(S
  <sub>i</sub> &times; P<sub>i</sub> &times; M<sub>i</sub>)
</pre>

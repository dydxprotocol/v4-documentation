...
| `SLINKY_CONFIG_PROVIDERS_STORK_API_API_ENDPOINTS_0_URL` | **No default - must set** | HTTPS URL of the Stork price feed Slinky pulls from. Slinky ships unset (`""`). Recommended: `https://oracle-relay-staging.dydx.trade/prices`. |

<details>
<summary>Terms of Use for `oracle-relay-staging.dydx.trade`</summary>

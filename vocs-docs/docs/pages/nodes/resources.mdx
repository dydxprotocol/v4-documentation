...
| 54,450,001 ~            | [v9.0.0](https://github.com/dydxprotocol/v4-chain/releases/tag/protocol%2Fv9.0.0)                                                                                                                                                                               | `v9.0.0` <ul><li>TWAP Orders</li><li>Order Router Revenue Sharing</li><li>Proposer Set Reduction</li></ul>                                                                                                        |
...
| 46,589,846 ~            | [v9.0.0](https://github.com/dydxprotocol/v4-chain/releases/tag/protocol%2Fv9.0.0)                                                                                                                                                                                                                                                                      |                                          |

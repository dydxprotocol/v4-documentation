...
| 48,980,001 ~            | [v8.1.0](https://github.com/dydxprotocol/v4-chain/releases/tag/protocol%2Fv8.1.0)                                                                                                                                                                               | `v8.1.0` <ul><li>Builder Codes</li><li>Clob Transaction Batching</li><li>Cross Instant Market Listings</li><li>IML_5x liquidity tier</li></ul>                                                                    |

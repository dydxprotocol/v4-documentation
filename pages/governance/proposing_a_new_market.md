...
- Safe (Not susceptible to market manipulation e.g. [Mango](https://www.notion.so/601722959e6d42ad8636f0e827885e9f?pvs=21))
...
|--------------|-------|-------------|-------|
| `MsgCreateOracleMarket` | `exponent` | TODO: definition | `p-9` |

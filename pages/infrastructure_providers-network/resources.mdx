...
| 26,785,001 ~            | [v6.0.4](https://github.com/dydxprotocol/v4-chain/releases/tag/protocol%2Fv6.0.4)                                                                                                                                                                               | `v6.0.4` Integrates and adds Marketmap functionality, expands transaction sequence number validation to accept timestamp nonces, and introduces individual vault parameters.            |
  </Tab>
</Tabs>

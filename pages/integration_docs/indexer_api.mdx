...
- <a href="https://dydx-testnet.imperator.co/v4">
...
| --------------------------- | ------------------------------------------------------------------------- | -------- | ------------ | ----------- |
| _anonymous_                 | [[SubaccountResponseObject](#schemasubaccountresponseobject)]             | false    | none         | none        |
...
fetch(
  "https://dydx-testnet.imperator.co/v4/candles/perpetualMarkets/{ticker}?resolution=1MIN&limit=0",
  {
    method: "GET",
...
fetch(
  "https://dydx-testnet.imperator.co/v4/fills?address=string&subaccountNumber=0&market=string&marketType=PERPETUAL&limit=0",
  {
    method: "GET",
...
fetch(
  "https://dydx-testnet.imperator.co/v4/historicalFunding/{ticker}?limit=0",
  {
    method: "GET",
...
fetch(
  "https://dydx-testnet.imperator.co/v4/historical-pnl?address=string&subaccountNumber=0&limit=0",
  {
    method: "GET",
...
fetch(
  "https://dydx-testnet.imperator.co/v4/orderbooks/perpetualMarket/{ticker}",
  {
    method: "GET",
...
fetch(
  "https://dydx-testnet.imperator.co/v4/orders?address=string&subaccountNumber=0&limit=0",
  {
    method: "GET",
...
| Name               | Type                                                | Required | Restrictions | Description |
| ------------------ | --------------------------------------------------- | -------- | ------------ | ----------- |
| _anonymous_        | [[OrderResponseObject](#schemaorderresponseobject)] | false    | none         | none        |
...
| Name           | Type                              | Required | Restrictions | Description |
| -------------- | --------------------------------- | -------- | ------------ | ----------- |
| »» _anonymous_ | [OrderStatus](#schemaorderstatus) | false    | none         | none        |

_or_

| Name           | Type                                                    | Required | Restrictions | Description |
| -------------- | ------------------------------------------------------- | -------- | ------------ | ----------- |
| »» _anonymous_ | [BestEffortOpenedStatus](#schemabesteffortopenedstatus) | false    | none         | none        |
...
| _anonymous_ | BEST_EFFORT_CANCELED |
| _anonymous_ | UNTRIGGERED          |
| _anonymous_ | BEST_EFFORT_OPENED   |
...
fetch(
  "https://dydx-testnet.imperator.co/v4/perpetualPositions?address=string&subaccountNumber=0&status=OPEN&limit=0",
  {
    method: "GET",
...
fetch(
  "https://dydx-testnet.imperator.co/v4/trades/perpetualMarket/{ticker}?limit=0",
  {
    method: "GET",
...
fetch(
  "https://dydx-testnet.imperator.co/v4/transfers?address=string&subaccountNumber=0&limit=0",
  {
    method: "GET",
...
| _anonymous_ | STOP_MARKET          |
| _anonymous_ | TRAILING_STOP        |
| _anonymous_ | TAKE_PROFIT          |
| _anonymous_ | TAKE_PROFIT_MARKET   |
| _anonymous_ | HARD_TRADE           |
| _anonymous_ | FAILED_HARD_TRADE    |
| _anonymous_ | TRANSFER_PLACEHOLDER |
...
| _anonymous_ | ACTIVE       |
| _anonymous_ | PAUSED       |
| _anonymous_ | CANCEL_ONLY  |
| _anonymous_ | POST_ONLY    |
| _anonymous_ | INITIALIZING |
...
| Property    | Value        |
| ----------- | ------------ |
| _anonymous_ | TRANSFER_IN  |
| _anonymous_ | TRANSFER_OUT |
| _anonymous_ | DEPOSIT      |
| _anonymous_ | WITHDRAWAL   |

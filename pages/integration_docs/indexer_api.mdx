...
r = requests.get('https://indexer.v4testnet2.dydx.exchange/v4/trades/perpetualMarket/{ticker}', params={
  'limit': '0'
}, headers = headers)
...
fetch('https://indexer.v4testnet2.dydx.exchange/v4/trades/perpetualMarket/{ticker}?limit=0',
{
  method: 'GET',
